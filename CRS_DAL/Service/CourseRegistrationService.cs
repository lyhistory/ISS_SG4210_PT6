...
namespace CRS_DAL.Service
{
    public class CourseRegistrationService
    {
        ...
        public List<dm.Course.CourseClass> GetCourseClassWithRegisterCount(DateTime date, int status)
        {
            ...
            IQueryable<Registration> registerList=RegistrationRepository.GetAll();

            return (from courseClass in courseClassList
                    join course in courseList on courseClass.CourseCode equals course.CourseCode
                    ...
                    select new dm.Course.CourseClass
                            {
                                ...
                                Status = (dm.Course.ClassStatus)courseClass.Status,
                                NoOfRegedParticipant = registerCollect.Count()
                            }).ToList();
        }
