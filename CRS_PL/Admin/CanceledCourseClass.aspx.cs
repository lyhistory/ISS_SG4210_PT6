...
{
    public partial class CanceledCourseClass : CrsPageController
    { //TODO
        ...
        private void ShowCourseClassList()
        {
            ...
            List<CourseClass> courseClasses = manager.GetCourseClassWithRegisterCount(DateTime.Now, ClassStatus.Canceled);
